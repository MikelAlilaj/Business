        ...
        <div class="container">
            <div class="row">
                        ...
                        @if($doc->file)
                            <div class="clone hide">
                                <div class="control-group1 input-group" style="margin-top:20px" >
                                    ...
                                    <iframe src = "{{ URL::to('storage/businessDocs/'.$doc->file) }}" width='700' height='150' allowfullscreen webkitallowfullscreen></iframe>
                ...
                @foreach($business->photos as $photo)
                    @if($photo->file)
                        <div class="row">
                            <div class="control-group1 input-group" style="margin-left:20px" >
                                <img src="{{ URL::to('storage/businessImages/'.$photo->file) }}" alt="img" height="100;" width="100;">
    ...
    <script>
        ...
        function initAutocomplete1()
        {
            ...
            google.maps.event.addListener(locationMap, 'click', function(event) {
                ...
                if(marker1 === false){
                    markers1.position(clickedLocation1);
                    //Create the marker.
