      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p class="mb-4 h5 font-italic lineheight1-5">&ldquo;L&rdquo;</p>
            <p>&mdash; <strong class="text-black font-weight-bold"></strong>, </p>
            <p><a href="https://vimeo.com/" class="popup-vimeo text-uppercase">Watch Video <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
